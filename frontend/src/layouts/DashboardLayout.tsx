...
import { LayoutDashboard, Car, Settings, LogOut, Smartphone, CreditCard, BookOpen, Menu, X, MessageSquare, Calculator, Users } from 'lucide-react';
...
const sidebarItems = [
    ...
    { icon: MessageSquare, label: 'Conversas (Ao Vivo)', path: '/dashboard/chat' },
